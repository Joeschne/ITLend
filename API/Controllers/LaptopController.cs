...
namespace API.Controllers
{
    ...
    public class LaptopController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutLaptop(int id, LaptopDTO laptopDTO)
        {
            ...
            laptop.AvailabilityStatus = laptopDTO.IsAvailable;
            laptop.Model = laptopDTO.Model;
            laptop.SerialNumber = laptopDTO.SerialNumber;
        ...
        private static LaptopDTO MapToDTO(Laptop laptop)
        {
            ...
            {
                Id = laptop.Id,
                IsAvailable = laptop.AvailabilityStatus,
                Model = laptop.Model,
        ...
        private static Laptop MapToModel(LaptopDTO laptopDTO)
        {
            ...
            {
                Id = laptopDTO.Id,
                AvailabilityStatus = laptopDTO.IsAvailable,
